...
<html lang="en">
  <head>
    ...
    <script>
      (function () {
        emailjs.init('CX_E5F5YQ0OZNcWAX');
      })();
    </script>
  </head>
  <body>
	...
	<div class="contacts-main">
		...
		<div class="form-41-mian py-5">
			<div class="container py-md-3">
				<h3 class="cont-head">Entrer en contact pour cette annonce</h3>
				<div class="d-grid align-form-map">
					<div class="form-inner-cont">
          <form action="reserTraitement.php" method="post" class="main-input" id="form">
		
              <input type="text" name="ref" id="ref" placeholder="Ref annonce">
					...
					<div class="contact-right">
						<img src="<?php echo $imageLink; ?>" class="img-fluid"  alt="Image" id="displayedImage">
					</div>
        </form>
				</div>
			</div>
...
<script>
  // Récupérer l'URL de l'image depuis le stockage local et l'afficher
  const savedImageUrl = localStorage.getItem('savedImageUrl');
  console.log(savedImageUrl);

  document.getElementById('displayedImage').src = savedImageUrl;
...
<script>
  function SendRequest() {
    ...
    const serviceID = 'service_1fr0d38';
   const templateID = 'template_lq54z72';
  document.getElementById('displayedImage').src = savedImageUrl;
   var params ={
           sendername: document.querySelector('#name').value,
           senderemail: document.querySelector('#email').value,
           sendertel: document.querySelector('#tel').value,
           senderref: document.querySelector('#ref').value,
           senderlink: savedImageUrl,
